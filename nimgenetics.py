...
def makeCorpus(f_path, image_path):
    ...
    """
    Esta función toma las imágenes correspondientes a un informe (PDF). El número de páginas del PDF indica el número
    de imágenes que serán transformadas a texto. El proceso se ejecuta utilizando un set único de identificadores los cuales
    se corresponden con el nombre de las imágenes. Este nombre siempre es el mismo teniendo en cuenta el PDF de procedencia.
